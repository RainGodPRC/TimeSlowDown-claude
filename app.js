...
const App = (() => {
  ...
  route('media', ({ view, navigate }) => {
    ...
    view.appendChild(el('div', {}, [
      ...
      el('div', { class: 'card' }, [
        el('div', { class: 'list-row' }, [el('div', { class: 'list-row__icon' }, ['🔒']), el('div', { class: 'list-row__main' }, [el('div', { class: 'list-row__title' }, [t('capsule.e2ee')]), el('div', { class: 'list-row__sub' }, [t('media.e2ee-detail')])])]),
  ...
  route('settings', ({ view, navigate }) => {
    ...
    view.appendChild(el('div', {}, [
      ...
      el('div', { class: 'card' }, [
        ...
        el('div', { class: 'setting-row' }, [el('div', { class: 'setting-row__main' }, [el('div', { class: 'setting-row__title' }, [t('onboarding.visitor-pass')]), el('div', { class: 'setting-row__sub' }, [t('settings.no-login-needed')])]), el('span', { class: 'badge badge--pass' }, ['PASS'])]),
        el('div', { class: 'setting-row' }, [el('div', { class: 'setting-row__main' }, [el('div', { class: 'setting-row__title' }, [t('settings.recovery-key')]), el('div', { class: 'setting-row__sub' }, [t('settings.user-owned')])]), el('span', { class: 'badge badge--poc' }, ['PoC'])]),
        el('div', { class: 'setting-row' }, [el('div', { class: 'setting-row__main' }, [el('div', { class: 'setting-row__title' }, [t('settings.unsubscribe-retrieval')]), el('div', { class: 'setting-row__sub' }, [t('settings.memories-after-unsubscribe')])]), el('span', { class: 'badge badge--poc' }, ['PoC'])]),
      ]),
      el('p', { class: 'muted mt-2', style: 'font-size:11px;' }, [t('settings.account-key-not-cage')]),
