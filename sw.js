...
const CACHE = 'tsd-cc-v30';
const ASSETS = ['./', './index.html', './styles.css?v=30', './app.js?v=30', './data.js?v=30', './push.js?v=30', './widget.js?v=30', './manifest.json', './icon-192.png', './icon-512.png'];
