...
const CACHE = 'tsd-cc-v32';
const ASSETS = ['./', './index.html', './styles.css?v=32', './app.js?v=32', './data.js?v=32', './push.js?v=32', './widget.js?v=32', './manifest.json', './icon-192.png', './icon-512.png'];
