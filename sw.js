...
const CACHE = 'tsd-cc-v26';
const ASSETS = ['./', './index.html', './styles.css?v=25', './app.js?v=25', './data.js?v=25', './push.js?v=25', './widget.js?v=25', './manifest.json', './icon-192.png', './icon-512.png'];
