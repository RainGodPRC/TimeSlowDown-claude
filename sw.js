...
const CACHE = 'tsd-cc-v33';
const ASSETS = ['./', './index.html', './styles.css?v=33', './app.js?v=33', './data.js?v=33', './push.js?v=33', './widget.js?v=33', './manifest.json', './icon-192.png', './icon-512.png'];
