...
const CACHE = 'tsd-cc-v29';
const ASSETS = ['./', './index.html', './styles.css?v=29', './app.js?v=29', './data.js?v=29', './push.js?v=29', './widget.js?v=29', './manifest.json', './icon-192.png', './icon-512.png'];
